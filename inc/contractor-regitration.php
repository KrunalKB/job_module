...
?>
    <form method="post" class="reg_form" id="regfrm">
      <div class="container">
        ...
        <label for="buss_name"><b><?php echo esc_html('Bussiness name'); ?></b></label>
        <input
          type="text"
        ...
        <label for="buss_phone"><b><?php echo esc_html('Bussiness number'); ?></b></label>
        <input
          type="text"
        ...
        <button type="submit" class="co_registerbtn"><?php echo esc_html('Register'); ?></button>
      </div>
    </form>
